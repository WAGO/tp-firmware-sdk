...
$(STATEDIR)/config_fonts.targetinstall:
	...
	@$(call install_copy, config_fonts, 0, 0, 0755, /etc/config-tools);

#
# TODO: Add here all files that should be copied to the target
# Note: Add everything before(!) call to macro install_finish
#
	@$(call install_copy, config_fonts, 0, 0, 0755, $(CONFIG_FONTS_DIR)/config_fonts, /etc/config-tools/config_fonts)
