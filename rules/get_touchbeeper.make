...
$(STATEDIR)/get_touchbeeper.targetinstall:
	...
	@$(call install_copy, get_touchbeeper, 0, 0, 0755, /etc/config-tools);

#
# TODO: Add here all files that should be copied to the target
# Note: Add everything before(!) call to macro install_finish
#
	@$(call install_copy, get_touchbeeper, 0, 0, 0755, $(GET_TOUCHBEEPER_DIR)/get_touchbeeper, /etc/config-tools/get_touchbeeper)
