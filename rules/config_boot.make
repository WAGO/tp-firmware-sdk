...
$(STATEDIR)/config_boot.targetinstall:
	...
	@$(call install_copy, config_boot, 0, 0, 0755, /etc/config-tools);

#
# TODO: Add here all files that should be copied to the target
# Note: Add everything before(!) call to macro install_finish
#
	@$(call install_copy, config_boot, 0, 0, 0755, $(CONFIG_BOOT_DIR)/config_boot, /etc/config-tools/config_boot)
