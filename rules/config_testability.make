...
$(STATEDIR)/config_testability.targetinstall:
	...
	@$(call install_copy, config_testability, 0, 0, 0755, /etc/config-tools);

#
# TODO: Add here all files that should be copied to the target
# Note: Add everything before(!) call to macro install_finish
#
	@$(call install_copy, config_testability, 0, 0, 0755, $(CONFIG_TESTABILITY_DIR)/config_testability, /etc/config-tools/config_testability)
