...
$(STATEDIR)/config_configured.targetinstall:
	...
	@$(call install_copy, config_configured, 0, 0, 0755, /etc/config-tools);

#
# TODO: Add here all files that should be copied to the target
# Note: Add everything before(!) call to macro install_finish
#
	@$(call install_copy, config_configured, 0, 0, 0755, $(CONFIG_CONFIGURED_DIR)/config_configured, /etc/config-tools/config_configured)
