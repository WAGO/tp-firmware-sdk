...
ifndef PTXCONF_WAGO_TOOLS_BUILD_VERSION_BINARIES
	...
	cp $(CANOPEN_DIR)/lib_CANopen/libcanopen.so.1.4 $(PTXCONF_SYSROOT_TARGET)/usr/lib
	...
	ln $(PTXCONF_SYSROOT_TARGET)/usr/lib/libcanopen.so.1.4 $(PTXCONF_SYSROOT_TARGET)/usr/lib/libcanopen.so
...
ifdef PTXCONF_WAGO_TOOLS_BUILD_VERSION_BINARIES 
	...
	@$(call install_link, canopen, libcanopen.so.1.4 , /usr/lib/libcanopen.so)
