...
CDS3_TSCTIME_PACKAGE_DIR := $(PTXDIST_TEMPDIR)/package/$(CDS3_TSCTIME_PACKAGE_NAME)
...
ifdef PTXCONF_WAGO_TOOLS_BUILD_VERSION_BINARIES
	...
	mkdir -p $(CDS3_TSCTIME_PACKAGE_DIR)
	cd $(CDS3_TSCTIME_PACKAGE_DIR) && \
	ar -xov $(CDS3_TSCTIME_PLATFORMCONFIGPACKAGEDIR)/$(CDS3_TSCTIME_PACKAGE_NAME).ipk
	@$(call install_archive, cds3-tsctime, 0, 0, $(CDS3_TSCTIME_PACKAGE_DIR)/data.tar.gz, )
else
	# WAGO_TOOLS_BUILD_VERSION_TRUNK | WAGO_TOOLS_BUILD_VERSION_RELEASE
