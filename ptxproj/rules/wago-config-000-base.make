...
CONFIG_TOOL_BASE_XSOURCE       := $(call ptx/in-path, PTXDIST_PATH, local_src/config-tools) 
ifeq ($(HOST_LIBOSLINUX_XSOURCE),)
CONFIG_TOOL_BASE_XSOURCE	:= $(PTXDIST_WORKSPACE)/local_src/config-tools
endif
...
$(STATEDIR)/config-tool-base.extract:
    ...
    $(CONFIG_TOOL_BASE_XSOURCE) $(BUILDDIR)
	@$(call touch)
