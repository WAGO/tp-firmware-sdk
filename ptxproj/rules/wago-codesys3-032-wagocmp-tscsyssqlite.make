...
CDS3_TSCSYSSQLITE_BIN_DIR        := $(CDS3_TSCSYSSQLITE_BUILDROOT_DIR)/bin/$(CDS3_TSCSYSSQLITE_BUILDCONFIG)
...
CDS3_TSCSYSSQLITE_PACKAGE_DIR := $(PTXDIST_TEMPDIR)/package/$(CDS3_TSCSYSSQLITE_PACKAGE_NAME)

CDS3_TSCSYSSQLITE_MAKE_ENV       := $(CROSS_ENV) \
BUILDCONFIG=$(CDS3_TSCSYSSQLITE_BUILDCONFIG) \
BIN_DIR=$(CDS3_TSCSYSSQLITE_BIN_DIR) \
...
ifdef PTXCONF_WAGO_TOOLS_BUILD_VERSION_BINARIES
	...
	mkdir -p $(CDS3_TSCSYSSQLITE_PACKAGE_DIR)
	cd $(CDS3_TSCSYSSQLITE_PACKAGE_DIR) && \
	ar -xov $(CDS3_TSCSYSSQLITE_PLATFORMCONFIGPACKAGEDIR)/$(CDS3_TSCSYSSQLITE_PACKAGE_NAME).ipk
	@$(call install_archive, cds3-tscsyssqlite, 0, 0, $(CDS3_TSCSYSSQLITE_PACKAGE_DIR)/data.tar.gz, )
else
	# WAGO_TOOLS_BUILD_VERSION_TRUNK | WAGO_TOOLS_BUILD_VERSION_RELEASE
	@$(call install_copy, cds3-tscsyssqlite, 0, 0, 0750, $(CDS3_TSCSYSSQLITE_BIN_DIR)/lib$(CDS3_TSCSYSSQLITE).so, /usr/lib/$(CDS3_TSCSYSSQLITE_BIN))
