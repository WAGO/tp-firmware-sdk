...
CDS3_TSCRETAINUIO_VERSION	 := 0.0.2
...
CDS3_TSCRETAINUIO_PACKAGE_DIR := $(PTXDIST_TEMPDIR)/package/$(CDS3_TSCRETAINUIO_PACKAGE_NAME)
...
ifdef PTXCONF_WAGO_TOOLS_BUILD_VERSION_BINARIES
	...
	mkdir -p $(CDS3_TSCRETAINUIO_PACKAGE_DIR)
	cd $(CDS3_TSCRETAINUIO_PACKAGE_DIR) && \
	ar -xov $(CDS3_TSCRETAINUIO_PLATFORMCONFIGPACKAGEDIR)/$(CDS3_TSCRETAINUIO_PACKAGE_NAME).ipk
	@$(call install_archive, cds3-tscretainuio, 0, 0, $(CDS3_TSCRETAINUIO_PACKAGE_DIR)/data.tar.gz, )
else
	# WAGO_TOOLS_BUILD_VERSION_TRUNK | WAGO_TOOLS_BUILD_VERSION_RELEASE
