...
LIBCTCALLHELPER_URL		:= file://local_src/$(LIBCTCALLHELPER)
LIBCTCALLHELPER_SRC		:= $(call ptx/in-path, PTXDIST_PATH, local_src/$(LIBCTCALLHELPER))
LIBCTCALLHELPER_DIR		:= $(BUILDDIR)/$(LIBCTCALLHELPER)
LIBCTCALLHELPER_LICENSE	:= unknown
ifeq ($(LIBCTCALLHELPER_SRC),)
LIBCTCALLHELPER_SRC	:= $(PTXDIST_WORKSPACE)/local_src/$(LIBCTCALLHELPER)
endif
