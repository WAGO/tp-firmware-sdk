...
LIBBACNETSTACK_VERSION           := rev$(LIBBACNETSTACK_REVISION)_$(LIBBACNETSTACK_SO_VERSION)
...
ifeq ($(LIBBACNETSTACK_ENV_VENDOR), WAGO)
	...
	@mkdir -p $(LIBBACNETSTACK_PKGDIR)/home/user/bacnet
	@$(call install_tree, libbacnetstack, 0, 0, -, /home/user/bacnet)
endif
