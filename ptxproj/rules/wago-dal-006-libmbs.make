...
ifndef PTXCONF_WAGO_TOOLS_BUILD_VERSION_BINARIES
		...
		$(NOPRINT)cd $(LOCAL_LIBMBS_PROJDIR)  &&  $(LIBMBS_ENV) PATH=$(CROSS_PATH) DIST_DIR=$(PTXDIST_PLATFORMDIR) \
                     CROSS_COMPILE=$(COMPILER_PREFIX)  $(MAKE)
		$(NOPRINT)cd $(LOCAL_TESTAPP_PROJDIR) &&  $(LIBMBS_ENV) PATH=$(CROSS_PATH) DIST_DIR=$(PTXDIST_PLATFORMDIR) \
