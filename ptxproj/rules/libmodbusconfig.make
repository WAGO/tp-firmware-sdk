...
LIBMODBUSCONFIG_VERSION_MICRO := 2
...
LIBMODBUSCONFIG_URL		:= file://wago_intern/device/modbus/config/
LIBMODBUSCONFIG_SRC		:= $(call ptx/in-path, PTXDIST_PATH, wago_intern/device/modbus/config)/
LIBMODBUSCONFIG_DIR		:= $(BUILDDIR)/$(LIBMODBUSCONFIG)
LIBMODBUSCONFIG_MD5		:=
LIBMODBUSCONFIG_LICENSE	:= unknown
LIBMODBUSCONFIG_DEVPKG  := NO
