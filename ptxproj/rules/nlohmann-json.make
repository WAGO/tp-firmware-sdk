...
# Paths and names
#
NLOHMANN_JSON_BASE_VERSION := 3.11.3
NLOHMANN_JSON_VERSION      := $(NLOHMANN_JSON_BASE_VERSION)+wago1
NLOHMANN_JSON_MD5          := d603041cbc6051edbaa02ebb82cf0aa9
NLOHMANN_JSON_ARCHIVE_NAME := nlohmann-json-v$(NLOHMANN_JSON_BASE_VERSION)
NLOHMANN_JSON              := nlohmann-json-v$(NLOHMANN_JSON_VERSION)
NLOHMANN_JSON_SUFFIX       := tar.gz
NLOHMANN_JSON_URL          := https://github.com/nlohmann/json/archive/v$(NLOHMANN_JSON_BASE_VERSION).$(NLOHMANN_JSON_SUFFIX)
NLOHMANN_JSON_SOURCE       := $(SRCDIR)/$(NLOHMANN_JSON_ARCHIVE_NAME).$(NLOHMANN_JSON_SUFFIX)
