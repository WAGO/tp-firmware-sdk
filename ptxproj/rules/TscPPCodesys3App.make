...
TSCPPCODESYS3APP_BIN_DIR        := $(TSCPPCODESYS3APP_BUILDROOT_DIR)/bin/$(TSCPPCODESYS3APP_BUILDCONFIG)
...
BIN_DIR=$(TSCPPCODESYS3APP_BIN_DIR) \
...
$(STATEDIR)/tscppcodesys3app.targetinstall:
	...
	@$(call install_copy, tscppcodesys3app, 0, 0, 755, -, /etc/config-tools/get_codesys_application_info)
