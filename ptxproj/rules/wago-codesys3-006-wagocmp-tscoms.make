...
CDS3_TSCOMS_PACKAGE_DIR := $(PTXDIST_TEMPDIR)/package/$(CDS3_TSCOMS_PACKAGE_NAME)
...
$(STATEDIR)/cds3-tscoms.prepare:
	@$(call targetinfo)
ifndef PTXCONF_WAGO_TOOLS_BUILD_VERSION_BINARIES
	$(MAKE) -C $(CDS3_TSCOMS_DIR) SYSROOT=$(PTXCONF_SYSROOT_TARGET) dep
endif
	@$(call touch)
...
ifdef PTXCONF_WAGO_TOOLS_BUILD_VERSION_BINARIES
	...
	mkdir -p $(CDS3_TSCOMS_PACKAGE_DIR)
	cd $(CDS3_TSCOMS_PACKAGE_DIR) && \
	ar -xov $(CDS3_TSCOMS_PLATFORMCONFIGPACKAGEDIR)/$(CDS3_TSCOMS_PACKAGE_NAME).ipk
	@$(call install_archive, cds3-tscoms, 0, 0, $(CDS3_TSCOMS_PACKAGE_DIR)/data.tar.gz, )
else
	# WAGO_TOOLS_BUILD_VERSION_TRUNK | WAGO_TOOLS_BUILD_VERSION_RELEASE
