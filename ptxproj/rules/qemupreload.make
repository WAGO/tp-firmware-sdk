...
QEMUPRELOAD_SRC_DIR        := $(call ptx/in-path, PTXDIST_PATH, wago_intern/$(QEMUPRELOAD))
QEMUPRELOAD_BUILDROOT_DIR  := $(BUILDDIR)/$(QEMUPRELOAD)/lib
QEMUPRELOAD_DIR            := $(QEMUPRELOAD_BUILDROOT_DIR)/src
QEMUPRELOAD_BIN_DIR        := $(QEMUPRELOAD_BUILDROOT_DIR)/bin/$(QEMUPRELOAD_BUILDCONFIG)
...
BIN_DIR=$(QEMUPRELOAD_BIN_DIR) \
SCRIPT_DIR=$(PTXDIST_SYSROOT_HOST)/usr/lib/ct-build \
PTXDIST_PACKAGE_MK_FILE=$(call ptx/in-path, PTXDIST_PATH, rules/qemupreload.make)
