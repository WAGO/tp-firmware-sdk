...
ONLINE_UPDATE_BIN_DIR        := $(ONLINE_UPDATE_BUILDROOT_DIR)/bin/$(ONLINE_UPDATE_BUILDCONFIG)
...
# normal mode, call "make install"
	...
	@mkdir -p $(ONLINE_UPDATE_PKGDIR)/etc/config-tools/
		@cp $(ONLINE_UPDATE_BIN_DIR)/$(ONLINE_UPDATE).elf $(ONLINE_UPDATE_PKGDIR)/etc/config-tools/$(ONLINE_UPDATE)
