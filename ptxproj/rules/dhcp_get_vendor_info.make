...
DHCP_GET_VENDOR_INFO_BIN_DIR        := $(DHCP_GET_VENDOR_INFO_BUILDROOT_DIR)/bin/$(DHCP_GET_VENDOR_INFO_BUILDCONFIG)
...
BIN_DIR=$(DHCP_GET_VENDOR_INFO_BIN_DIR) \
...
# normal mode, call "make install"
	...
	@mkdir -p $(DHCP_GET_VENDOR_INFO_PKGDIR)/etc/config-tools/
		@cp $(DHCP_GET_VENDOR_INFO_BIN_DIR)/$(DHCP_GET_VENDOR_INFO).elf $(DHCP_GET_VENDOR_INFO_PKGDIR)/etc/config-tools/$(DHCP_GET_VENDOR_INFO)
