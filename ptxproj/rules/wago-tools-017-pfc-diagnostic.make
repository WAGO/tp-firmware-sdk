...
WAGO_PFC_DIAGNOSTIC_VERSION	:= 2.1.1
WAGO_PFC_DIAGNOSTIC		:= wago-pfc-diagnostic
WAGO_PFC_DIAGNOSTIC_VER		:= wago-pfc-diagnostic-$(WAGO_PFC_DIAGNOSTIC_VERSION)
endif

WAGO_PFC_DIAGNOSTIC_URL		:= file:///local_src/$(WAGO_PFC_DIAGNOSTIC)
...
#	#
	...
	@$(call install_copy, wago-pfc-diagnostic, 0, 0, 0755, -, /etc/specific/led.CC100.xml)
	@$(call install_link, wago-pfc-diagnostic, "../../etc/specific/led.CC100.xml", "/etc/specific/led.0x1011.CC100.xml")
	@$(call install_link, wago-pfc-diagnostic, "../../etc/specific/led.CC100.xml", "/etc/specific/led.0x1012.CC100.xml")
	@$(call install_link, wago-pfc-diagnostic, "../../etc/specific/led.CC100.xml", "/etc/specific/led.0x1013.CC100.xml")
	@$(call install_link, wago-pfc-diagnostic, "../../etc/specific/led.CC100.xml", "/etc/specific/led.0x1018.CC100.xml")
	@$(call install_copy, wago-pfc-diagnostic, 0, 0, 0755, -, /etc/specific/led.0x1015.WP400.xml)
	@$(call install_copy, wago-pfc-diagnostic, 0, 0, 0755, -, /etc/specific/led.0x1016.WP400.xml)
	@$(call install_copy, wago-pfc-diagnostic, 0, 0, 0755, -, /etc/specific/led.0x1017.WP400.xml)
	...
	@$(call install_link, wago-pfc-diagnostic, "../../etc/specific/led.0x000C.PFC200.xml", "/etc/specific/led.0x100C.PFC300.xml")
	...
	@$(call install_copy, wago-pfc-diagnostic, 0, 0, 0755, -, /etc/specific/led.0x100C.PFC300.xml)

	@$(call install_alternative, wago-pfc-diagnostic, 0, 0, 0755, /etc/specific/led_info.json)

ifdef PTXCONF_LOGFORWARD_STARTSCRIPT
	@$(call install_alternative, wago-pfc-diagnostic, 0, 0, 0755, \
