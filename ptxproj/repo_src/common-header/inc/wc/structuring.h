...
//generic version
#define WC_UNUSED_PARAM(x) \
    unused_##x __attribute__((unused))
#else // Lint
...
/// \def WC_FALLTHROUGH
/// Helper macro to indicate a switch case fallthrough.
#ifdef __cplusplus // C++
#if (__cplusplus >= 201703L) // C++ >= 201703
#define WC_FALLTHROUGH [[fallthrough]]
#elif defined(__GNUC__) && (__cplusplus >= 201103L) // GCC with C++ >= 201103
#define WC_FALLTHROUGH [[gnu::fallthrough]]
#elif defined(__GNUC__)
#define WC_FALLTHROUGH __attribute__ ((fallthrough))
#endif
#elif defined(__GNUC__) // GCC with C
#define WC_FALLTHROUGH __attribute__ ((fallthrough))
#else
#pragma message("WARNING: You need to implement FALLTHROUGH for this compiler")
#define WC_FALLTHROUGH
#endif
