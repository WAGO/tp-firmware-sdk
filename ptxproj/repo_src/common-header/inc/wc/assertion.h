...
// parasoft-begin-suppress CERT_C-PRE31-c "Use case requires function-like call. Call to WC_STR has no side-effects."
...
#define WC_ASSERT(e) do { ((void)sizeof(e)); } while(0) //lint -e 506 Constant value Boolean
#endif // NDEBUG
...
#define WC_FAIL(reason) do { ((void)sizeof(reason)); } while(0) //lint -e 506 Constant value Boolean
#endif // NDEBUG
