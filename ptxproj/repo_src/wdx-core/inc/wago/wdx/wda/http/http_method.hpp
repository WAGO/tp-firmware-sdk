...
//------------------------------------------------------------------------------
#ifndef INC_WAGO_WDX_WDA_HTTP_HTTP_METHOD_HPP_
#define INC_WAGO_WDX_WDA_HTTP_HTTP_METHOD_HPP_
...
/// \throws 
///    wago::wdx::wda::xception is thrown, when method_name is not matching 
...
#endif // INC_WAGO_WDX_WDA_HTTP_HTTP_METHOD_HPP_
//---- End of source file ------------------------------------------------------
