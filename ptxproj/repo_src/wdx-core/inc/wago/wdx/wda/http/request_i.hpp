...
//------------------------------------------------------------------------------
#ifndef INC_WAGO_WDX_WDA_HTTP_REQUEST_I_HPP_
#define INC_WAGO_WDX_WDA_HTTP_REQUEST_I_HPP_
...
/// (wago::wdx::wda::ttp::http_request_handler_i). The implementation
...
#endif // INC_WAGO_WDX_WDA_HTTP_REQUEST_I_HPP_
//---- End of source file ------------------------------------------------------
