...
///  \file
//------------------------------------------------------------------------------
#ifndef SRC_LIBWDXCORE_WDA_IPC_JSON_REPRESENTATION_HPP_
#define SRC_LIBWDXCORE_WDA_IPC_JSON_REPRESENTATION_HPP_
...
#endif // SRC_LIBWDXCORE_WDA_IPC_JSON_REPRESENTATION_HPP_
