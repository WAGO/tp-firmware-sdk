...
//------------------------------------------------------------------------------
#ifndef INC_WAGO_AUTHSERV_HTTP_RESPONSE_I_HPP_
#define INC_WAGO_AUTHSERV_HTTP_RESPONSE_I_HPP_
...
/// (wago::paramserv::http::http_request_i). Is is able to provide 
...
public:
    ...
    virtual headermap   const & get_response_header() const = 0;

    /// Get the content type of the response body
    /// \return 
    ///    The content type of the response body
    virtual std::string const & get_content_type() const = 0;

    /// Get the content length of the response body
    /// \return 
    ///    The content length of the response body
    virtual std::string const & get_content_length() const = 0;
...
#endif // INC_WAGO_AUTHSERV_HTTP_RESPONSE_I_HPP_
//---- End of source file ------------------------------------------------------
