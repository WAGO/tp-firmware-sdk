...
//------------------------------------------------------------------------------
#ifndef SRC_LIBWDXLINUXOSSERV_FCGI_CONTENT_STREAM_HPP_
#define SRC_LIBWDXLINUXOSSERV_FCGI_CONTENT_STREAM_HPP_
...
public:
    ...
    ~content_buffer() noexcept override;
...
#endif // SRC_LIBWDXLINUXOSSERV_FCGI_CONTENT_STREAM_HPP_
//---- End of source file ------------------------------------------------------
