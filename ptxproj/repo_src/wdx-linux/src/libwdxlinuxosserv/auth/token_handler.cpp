...
///  \file
///
///  \brief    Token handler implementation using libwagocryto.
///
...
//------------------------------------------------------------------------------
token_handler::handler_impl::handler_impl(uint32_t const key_lifetime_s)
: key_lifetime_m(key_lifetime_s)
...
time_t token_handler::handler_impl::get_next_key_expiration_time() const
{
    ...
    uint32_t const lifetime_s   = key_lifetime_m;
...
token_handler::token_handler(uint32_t const key_lifetime_s)
:impl(std::make_unique<handler_impl>(key_lifetime_s))
{ }
