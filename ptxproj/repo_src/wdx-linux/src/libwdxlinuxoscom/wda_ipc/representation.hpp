...
///  \file
//------------------------------------------------------------------------------
#ifndef SRC_LIBWDXLINUXOSCOM_WDA_IPC_REPRESENTATION_HPP_
#define SRC_LIBWDXLINUXOSCOM_WDA_IPC_REPRESENTATION_HPP_
...
#endif // SRC_LIBWDXLINUXOSCOM_WDA_IPC_REPRESENTATION_HPP_